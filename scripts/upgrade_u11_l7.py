"""G3 U11 L7 — Volume Word Problems 검증 메타 정합화 (3.MD.A.2)"""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
SRC  = ROOT / "backend/data/math/G3/U11_time_mass_volume/L7_volume_word_problems.json"

VERIFICATION = {
    "concept_source": "Go Math Grade 3 Ch.10 Lesson 10.7 'Volume Word Problems'",
    "procedure_source": "EngageNY Grade 3 Module 2 Topic E — Volume Problems",
    "assessment_source": "Smarter Balanced Grade 3 Mathematics Item Specifications 2015",
}
VERT_ALIGN = {
    "prerequisite": "G3 U11 L6 — 부피 추정·측정 (3.MD.A.2)",
    "current":      "G3 U11 L7 — 부피 문장제 (3.MD.A.2)",
    "successor":    "G3 U11 L8 — 시간·질량·부피 통합 (3.MD.A.1·A.2)",
}
...
def upgrade():
    ...
    d["metadata"]["upgrade_script"] = "scripts/upgrade_u11_l7.py"
