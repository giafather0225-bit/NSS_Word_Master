"""G3 U12 L3 — Area and Multiplication 검증 메타 정합화 (3.MD.C.7)"""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
SRC  = ROOT / "backend/data/math/G3/U12_area/L3_area_multiplication.json"

VERIFICATION = {
    "concept_source": "Go Math Grade 3 Ch.11 Lesson 11.3 'Area and Multiplication'",
    "procedure_source": "EngageNY Grade 3 Module 4 Topic B — Multiplication and Area",
    "assessment_source": "Smarter Balanced Grade 3 Mathematics Item Specifications 2015",
}
VERT_ALIGN = {
    "prerequisite": "G3 U12 L2 — 넓이 세기 측정 (3.MD.C.6)",
    "current":      "G3 U12 L3 — 넓이와 곱셈 (3.MD.C.7)",
    "successor":    "G3 U12 L4 — 넓이와 덧셈 관계 (3.MD.C.7)",
}
...
def upgrade():
    ...
    d["metadata"]["upgrade_script"] = "scripts/upgrade_u12_l3.py"
