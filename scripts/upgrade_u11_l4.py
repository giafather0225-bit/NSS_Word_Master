"""G3 U11 L4 — Estimate and Measure Mass 검증 메타 정합화 (3.MD.A.2)"""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
SRC  = ROOT / "backend/data/math/G3/U11_time_mass_volume/L4_estimate_measure_mass.json"

VERIFICATION = {
    "concept_source": "Go Math Grade 3 Ch.10 Lesson 10.4 'Estimate and Measure Mass'",
    "procedure_source": "EngageNY Grade 3 Module 2 Topic D — Mass",
    "assessment_source": "Smarter Balanced Grade 3 Mathematics Item Specifications 2015",
}
VERT_ALIGN = {
    "prerequisite": "G3 U11 L3 — 시간 문장제 (3.MD.A.1)",
    "current":      "G3 U11 L4 — 질량 추정·측정 (3.MD.A.2)",
    "successor":    "G3 U11 L5 — 질량 문장제 (3.MD.A.2)",
}
...
def upgrade():
    ...
    d["metadata"]["upgrade_script"] = "scripts/upgrade_u11_l4.py"
