"""G3 U13 L6 — Unit Fractions and Area 검증 메타 정합화 (3.G.A.2)"""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
SRC  = ROOT / "backend/data/math/G3/U13_shapes/L6_unit_fractions_area.json"

VERIFICATION = {
    "concept_source": "Go Math Grade 3 Ch.12 Lesson 12.6 'Unit Fractions of Shapes'",
    "procedure_source": "EngageNY Grade 3 Module 7 Topic F — Unit Fractions and Shape Area",
    "assessment_source": "Smarter Balanced Grade 3 Mathematics Item Specifications 2015",
}
VERT_ALIGN = {
    "prerequisite": "G3 U13 L5 — 도형 분할 (3.G.A.2)",
    "current":      "G3 U13 L6 — 단위 분수와 넓이 (3.G.A.2)",
    "successor":    "G3 U13 L7 — 도형·분수 통합 (3.G.A.1·A.2)",
}
...
def upgrade():
    ...
    d["metadata"]["upgrade_script"] = "scripts/upgrade_u13_l6.py"
