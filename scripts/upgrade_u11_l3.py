"""
G3 U11 L3 — Time Word Problems 검증 메타 정합화 (3.MD.A.1)
"""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
SRC  = ROOT / "backend/data/math/G3/U11_time_mass_volume/L3_time_word_problems.json"

VERIFICATION = {
    "concept_source": "Go Math Grade 3 Ch.10 Lesson 10.3 'Time Word Problems'",
    "procedure_source": "EngageNY Grade 3 Module 2 Topic A — Time Problems",
    "assessment_source": "Smarter Balanced Grade 3 Mathematics Item Specifications 2015",
}

VERT_ALIGN = {
    "prerequisite": "G3 U11 L2 — 경과 시간 수직선 (3.MD.A.1)",
    "current":      "G3 U11 L3 — 시간 문장제 (3.MD.A.1)",
    "successor":    "G3 U11 L4 — 질량 추정·측정 (3.MD.A.2)",
}
...
def upgrade():
    ...
    d["metadata"]["upgrade_script"] = "scripts/upgrade_u11_l3.py"
