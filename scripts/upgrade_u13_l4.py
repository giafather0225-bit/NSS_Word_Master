"""G3 U13 L4 — Compare Quadrilaterals 검증 메타 정합화 (3.G.A.1)"""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
SRC  = ROOT / "backend/data/math/G3/U13_shapes/L4_compare_quadrilaterals.json"

VERIFICATION = {
    "concept_source": "Go Math Grade 3 Ch.12 Lesson 12.4 'Compare Quadrilaterals'",
    "procedure_source": "EngageNY Grade 3 Module 7 Topic E — Quadrilateral Hierarchy",
    "assessment_source": "Smarter Balanced Grade 3 Mathematics Item Specifications 2015",
}
VERT_ALIGN = {
    "prerequisite": "G3 U13 L3 — 사각형 식별 (3.G.A.1)",
    "current":      "G3 U13 L4 — 사각형 비교 (3.G.A.1)",
    "successor":    "G3 U13 L5 — 도형 분할 (3.G.A.2)",
}
...
def upgrade():
    ...
    d["metadata"]["upgrade_script"] = "scripts/upgrade_u13_l4.py"
