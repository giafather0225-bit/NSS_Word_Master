"""G3 U11 L8 — Mixed Time/Mass/Volume 검증 메타 정합화 (3.MD.A.1·A.2)"""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
SRC  = ROOT / "backend/data/math/G3/U11_time_mass_volume/L8_mixed_time_mass_volume.json"

VERIFICATION = {
    "concept_source": "Go Math Grade 3 Ch.10 Lesson 10.8 'Mixed Time, Mass, Volume Problems'",
    "procedure_source": "EngageNY Grade 3 Module 2 End-of-Module — Mixed Measurement",
    "assessment_source": "Smarter Balanced Grade 3 Mathematics Item Specifications 2015",
}
VERT_ALIGN = {
    "prerequisite": "G3 U11 L7 — 부피 문장제 (3.MD.A.2)",
    "current":      "G3 U11 L8 — 시간·질량·부피 통합 (3.MD.A.1·A.2)",
    "successor":    "G3 U11 unit_test — 측정 단원 평가 (3.MD.A.1·A.2)",
}
...
def upgrade():
    ...
    d["metadata"]["upgrade_script"] = "scripts/upgrade_u11_l8.py"
