"""G3 U13 L5 — Partition Shapes 검증 메타 정합화 (3.G.A.2)"""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
SRC  = ROOT / "backend/data/math/G3/U13_shapes/L5_partition_shapes.json"

VERIFICATION = {
    "concept_source": "Go Math Grade 3 Ch.12 Lesson 12.5 'Partition Shapes into Equal Parts'",
    "procedure_source": "EngageNY Grade 3 Module 7 Topic F — Shape Partition",
    "assessment_source": "Smarter Balanced Grade 3 Mathematics Item Specifications 2015",
}
VERT_ALIGN = {
    "prerequisite": "G3 U13 L4 — 사각형 비교 (3.G.A.1)",
    "current":      "G3 U13 L5 — 도형 분할 (3.G.A.2)",
    "successor":    "G3 U13 L6 — 단위 분수와 넓이 (3.G.A.2)",
}
...
def upgrade():
    ...
    d["metadata"]["upgrade_script"] = "scripts/upgrade_u13_l5.py"
