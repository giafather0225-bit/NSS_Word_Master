"""G3 U12 L7 — Area Word Problems 검증 메타 정합화 (3.MD.C.7)"""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
SRC  = ROOT / "backend/data/math/G3/U12_area/L7_area_word_problems.json"

VERIFICATION = {
    "concept_source": "Go Math Grade 3 Ch.11 Lesson 11.7 'Area Word Problems'",
    "procedure_source": "EngageNY Grade 3 Module 4 Topic E — Area Problems",
    "assessment_source": "Smarter Balanced Grade 3 Mathematics Item Specifications 2015",
}
VERT_ALIGN = {
    "prerequisite": "G3 U12 L6 — 분배 법칙과 넓이 (3.MD.C.7)",
    "current":      "G3 U12 L7 — 넓이 문장제 (3.MD.C.7)",
    "successor":    "G3 U12 L8 — 넓이 vs 둘레 (3.MD.C.7·D.8)",
}
...
def upgrade():
    ...
    d["metadata"]["upgrade_script"] = "scripts/upgrade_u12_l7.py"
