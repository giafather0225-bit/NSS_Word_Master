"""G3 U13 L2 — Classify Polygons 검증 메타 정합화 (3.G.A.1)"""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
SRC  = ROOT / "backend/data/math/G3/U13_shapes/L2_classify_polygons.json"

VERIFICATION = {
    "concept_source": "Go Math Grade 3 Ch.12 Lesson 12.2 'Classify Polygons'",
    "procedure_source": "EngageNY Grade 3 Module 7 Topic E — Polygon Classification",
    "assessment_source": "Smarter Balanced Grade 3 Mathematics Item Specifications 2015",
}
VERT_ALIGN = {
    "prerequisite": "G3 U13 L1 — 다각형 설명 (3.G.A.1)",
    "current":      "G3 U13 L2 — 다각형 분류 (3.G.A.1)",
    "successor":    "G3 U13 L3 — 사각형 식별 (3.G.A.1)",
}
...
def upgrade():
    ...
    d["metadata"]["upgrade_script"] = "scripts/upgrade_u13_l2.py"
